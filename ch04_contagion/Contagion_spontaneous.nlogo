;;A simple model of adoption. Agents move around at random and spontaneously adopt a behavior.
...
;;infected agents with probability of spontaneous adoption.
...
to analytical-solve
  ...
  while [i < 1000] [
    ...
    set num-infected lput (x +  spontaneous-infect * (num-turtles - x)) num-infected
    set i (i + 1)
  ]
  show num-infected
end
...
* Smaldino PE (2023). Contagion: Spontaneous. Modeling Social Behavior.  https://github.com/psmaldino/modsoc/
