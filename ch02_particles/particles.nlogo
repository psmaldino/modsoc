...
to setup
  ...
  set-default-shape turtles "default" ;;make the turtles arrows (not strictly necessary as this is default)
  ...
  create-turtles num-particles [
    ...
    set heading random 360 ;;give them a random heading (not strictly necessary as this is default)
  ]
