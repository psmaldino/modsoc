;; A model of opinion dynamics based on:
...
;;
;; This version of the model considers a single trait that can take on a continuous value in [-1, 1], in a structured population
;; This version also ncludes repulsion from different opinions (negative influence)
;;
;;-----------------------------------------
...
turtles-own [initial-opinion opinion]
...
to go
  ...
  ask one-of turtles [
    ...
    ;;do they have a positive interaction and become more similar?
    ...
    ;;otherwise, they have a negative interaction and become more dissimilar
...
to-report num-cliques
  ...
  let min-value min [opinion] of (turtles with [opinion > (.5 * d)])
...
"" ""
PENS
"default" 1.0 2 -15390905 true "" "if (ticks mod 100 = 0) [\nask turtles [\nplotxy ticks opinion\n]\n]"
...
<experiments>
  <experiment name="experiment" repetitions="30" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="confidence-threshold" first="0.05" step="0.01" last="0.5"/>
