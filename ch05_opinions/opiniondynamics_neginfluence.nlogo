;; This version also includes repulsion from different opinions (negative influence)
...
* Smaldino PE (2023). Opinion Dynamics: Negative Influence. Modeling Social Behavior.  https://github.com/psmaldino/modsoc/
