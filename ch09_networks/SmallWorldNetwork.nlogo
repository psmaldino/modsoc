;;Create a small-world network with degree k=4
...
This model is original material created by Paul E. Smaldino, drawing on code by Wilensky (2015) and work by Watts and Strogatz (1998). 
...
* Smaldino PE (2023). Small World Network. Modeling Social Behavior.  https://github.com/psmaldino/modsoc/
